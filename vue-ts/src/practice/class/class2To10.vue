<template>
  <el-collapse v-model="activeNames">
    ...
    <el-collapse-item title="什么是防抖和节流？有什么区别？如何实现？" name="2">
      <div>
    ...
    <el-collapse-item title="下面的代码打印什么内容，为什么？" name="33">
      <el-button @click="run(code)">运行</el-button>
      <div class="flex">
        <prism-editor
          class="my-editor"
          v-model="code"
          ...
          line-numbers
        ></prism-editor>
        <div class="my-editor-result">{{ result }}</div>
      </div>
    ...
    >
      ...
      <div>
        ...
        var b = 10;<br />
        (function b(){ <br />
        var b = 20; //or let b = 20; var 具有全局作用域和函数块级作用域
        <br />console.log(this.b); //10 <br />console.log(b);//20 <br />})();
      </div>
    </el-collapse-item>
    <el-collapse-item title="下面代码输出什么" name="41">
      <div>
        ...
        块级作用域没有声明 <br />
        a = 5 <br />
        console.log(window.a) // 全局的a值 var a = 20;
        <br />console.log(a)；//声明了函数的块级作用域里的this })()
      </div>
      <div>
        输出<br />
        <br />
    ...
    >
      ...
      <div>
        返回值大于0 即a-b 大于 0 ， a 和 b 交换位置 <br />返回值大于0 即a-b 小于
        0 ， a 和 b 位置不变<br />
    ...
    >
      <div>
        <a href="https://www.jianshu.com/p/7c797a565f14"
          >call 和 apply 的区别是什么，哪个性能更好一些</a
        >
      </div>
      <div>
      ...
      <div>
        call 的方法更好一点 call 方法比 apply 快的原因是 call
        方法的参数格式正是内部方法所需要的格式
      </div>
    </el-collapse-item>
  </el-collapse>
